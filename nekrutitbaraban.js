  ...
  return (
    <>
      <div className="page-container10">
        <Head>
          <title>��тиральная машина не крутит барабан — что делать?</title>
          <meta property="og:title" content="Стиральная машина не крутит барабан ��� что делать?" />
        </Head>
        <Header />
          ...
          <div className="page-left-main-box">
              ...
              <div className="page-container13">
                ...
                <p className="vicetext page-text18">
                  ...
                  <span>
                    ...
                    фильтр (если т��ковой имеется). Это необходимо сделать перед
                    л��быми проверками, чтобы вода не помешала осмотру и не
                  ...
                  <span>
                    ...
                    уме��ьшите загрузку, если она была слишком большой. Если
                  ...
                  <span className="page-text31">
                    5. Зап��стите тестовый цикл без белья.
                  </span>
                  <span>
                    {' '}
            ...
            <section id="3" className="page-thirdproblem2">
              ...
              <div className="page-container20">
                ...
                <p className="vicetext">
                  {' '}
                  Если двигатель рабо��ает, слышен гул, но барабан не вращается
                  ...
                  возвращают н�� шкив, а при явных повреждениях ремень меняют —
            ...
            <section id="4" className="page-fiveproblem1">
              ...
              <div className="page-container23">
                ...
                <p className="page-text46 vicetext">
                  ...
                  не запускается; иногда слышен только гул мотора без ��вижения
                  ...
                  состоя��ие щёток, обмоток и подшипников и при необходимости
